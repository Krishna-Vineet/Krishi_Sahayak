...
var allRecords = [];
api = [
fetch('https://api.data.gov.in/resource/7e72bd2f-790a-4444-b111-40858b6a5f47?api-key=579b464db66ec23bdd000001a522f835223a413a64ef13452863c569&format=json&limit=all'),     //maida atta  2022  // api fetch kri, it will store a string
fetch('https://api.data.gov.in/resource/51e05af6-517c-4a13-8d38-caad3a38ca81?api-key=579b464db66ec23bdd000001a522f835223a413a64ef13452863c569&format=json&limit=50'),     // soji
fetch('https://api.data.gov.in/resource/fea3a2d7-60fd-403d-b167-30f3686549ba?api-key=579b464db66ec23bdd000001a522f835223a413a64ef13452863c569&format=json&limit=20'),    // bran
fetch('https://api.data.gov.in/resource/73140461-fda6-4e1b-9b6f-8026067a0077?api-key=579b464db66ec23bdd000001a522f835223a413a64ef13452863c569&format=json&limit=20000'),      // Wheat
fetch('https://api.data.gov.in/resource/adf1a9ed-5032-4631-a527-a45ad898d9bd?api-key=579b464db66ec23bdd000001a522f835223a413a64ef13452863c569&format=json&limit=800'),       // turmeric (raw)     
fetch('https://api.data.gov.in/resource/9ef84268-d588-465a-a308-a864a43d0070?api-key=579b464db66ec23bdd000001a522f835223a413a64ef13452863c569&format=json&limit=10000'),      // various comodities
fetch('https://api.data.gov.in/resource/14b041b6-e380-4c25-9782-cb0a8e480389?api-key=579b464db66ec23bdd000001a522f835223a413a64ef13452863c569&format=json&limit=all'),   // maize
]
api.forEach( (api) => {
